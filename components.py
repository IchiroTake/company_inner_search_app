...
このファイル内の関数は全て、main.pyから呼び出されるものです。
"""
...
def display_select_mode():
    ...
    with st.sidebar:
        st.subheader("利用目的")
        # 「label_visibility="collapsed"」でラベルは非表示
...
def display_initial_ai_message():
    ...
    with st.chat_message("assistant"):
        ...
        st.warning("具体的に入力したほうが期待通りの回答を得やすいです。", icon="⚠")
        
        # 「社内文書検索」の機能説明（サイドバーに表示）
        with st.sidebar:
            st.divider()
